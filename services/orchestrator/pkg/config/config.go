...
func Load() *Config {
	...
	cfg := &Config{
		...
		RoutingIntentsPath:               getEnv("ROUTING_INTENTS_PATH", "../../configs/routing_intents.json"),
		RoutingGroupsPath:                getEnv("ROUTING_GROUPS_PATH", "../../configs/routing_groups.json"),
		RoutingFeedbackPath:              getEnv("ROUTING_FEEDBACK_PATH", "../../configs/routing_feedback.jsonl"),
